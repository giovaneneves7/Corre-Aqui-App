	    	...
	    	final data = await apiClient.getData('offers');
	      	...
	      	return data.map((offer){
	      			...
	      			return Offer(
	      				...
	      				originalPrice: offer['original_price'] is int ? (offer['original_price'] as int).toDouble() : offer['original_price'] as double,
	      				offerPrice: offer['offer_price'] is int ? (offer['offer_price'] as int).toDouble() : offer['offer_price'] as double,
